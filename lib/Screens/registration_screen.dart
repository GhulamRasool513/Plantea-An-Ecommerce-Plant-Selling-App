    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: ConstrainedBox(
          constraints: BoxConstraints(minHeight: 590.0),
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Transform.scale(
                    scale: 1.3,
                    child: Theme(
                      data: ThemeData(unselectedWidgetColor: Color(0xff109C5B)),
                      child: Checkbox(
                        onChanged: (val) {
                          val = value;
                          setState(() {
              ...
              //final navigatorKey = GlobalKey<NavigatorState>(); button.
              SizedBox(
                width: 370.0,
                height: 55.0,
                child: TextButton(
                  ...
                  onPressed: () async {
                    ...
                    //       content: Text("Email already exits. Please use another email"),
                    //     ));
                    //   }
                      // ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      'or continue with',
                      style:
                          TextStyle(color: Color(0xff616161), fontSize: 17.0),
                    ),
                    HorizontalLines(100.0),
                  ],
                ),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Text(
                      ' Sign In',
                      style:
                          TextStyle(color: Color(0xff02B763), fontSize: 17.0),
                    ),
                  )
                ],
              )
